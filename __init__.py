...
from extensions import db  # Import the db object from the new extensions file
...
def create_app(config_class=Config):
    ...
    def update_status(status_id):
        ...
        if not status_id or not new_status_text:
            return jsonify({'error': 'Missing id or eventtype in request'}), 400
